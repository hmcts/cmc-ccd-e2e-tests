...
test.describe('Manage Documents', async () => {
  test('Claimant creates claim, caseworker performs Manage Documents action', {tag: '@debug'}, async({IdamSteps, ExuiDashboardSteps, CreateClaimSteps, ApiSteps, CaseworkerEventsSteps}) => {
