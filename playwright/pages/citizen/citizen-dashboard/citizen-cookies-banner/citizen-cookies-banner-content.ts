export const heading = 'Cookies on Money Claims';

export const paragraphs = {
  cookiesDescription1: 'We use some essential cookies to make this service work.',
  cookiesDescription2: 'We’d like to set additional cookies so we can remember your settings, understand how people use the service and to improve government services.',
...
export const buttons = {
  accept: {
    ...
    selector: '.govuk-button.cookie-banner-accept-button',
  },
  reject: {
