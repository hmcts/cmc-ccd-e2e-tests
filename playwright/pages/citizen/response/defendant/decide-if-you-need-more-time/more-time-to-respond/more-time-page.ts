...
export default class MoreTimePage extends CitizenEvent(BasePage) {
  async verifyContent() {
    await super.runVerifications([super.expectHeading(heading), super.expectText(radioButtons.moreTimeYes.label), super.expectText(radioButtons.moreTimeNo.label)]);
  }
