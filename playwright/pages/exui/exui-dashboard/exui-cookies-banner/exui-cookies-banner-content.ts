export const heading = 'Cookies on this service';

export const paragraphs = {
  cookiesDescription1: 'We use some essential cookies to make this service work.',
  cookiesDescription2: "We'd also like to use analytics cookies so we can understand how you use the service and make improvements.",
