...
Scenario(
  'Create Claimant flow then events claim notes, change contact details, resend rpa, reset pin, link letter holder id, attach via bulk scan, support updatee, transfer casee',
  async ({ I }) => {
    //claimant steps
    ...
    logger.info({
      message: 'Claimant has created a claim with reference..',
      claimRef,
    });
