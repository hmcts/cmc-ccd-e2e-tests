...
Feature('Paper response reviewed upload functionality').retry(
  testConfig.TestRetryFeatures,
);

Scenario(
  'Claimant create a case --> Caseworker submit N9 (Request more time)',
  async ({ I }) => {
...
Scenario(
  'Claimant create a case --> Caseworker submit N9a (Paper Admission - Full or Part)',
  async ({ I }) => {
    await I.amOnCitizenAppPage('');
    await I.authenticateWithIdam(userType.CITIZEN, true);
    const claimRef = await I.createClaimDefendantAsOrg();
    ...
    await I.waitForText('Claim created by citizen');
    await I.see('Claim submitted');
    await caseHelper.paperResponseReviewed(
      I,
...
Scenario(
  'Claimant create a case --> Caseworker submit N9b (Paper Defence/Counterclaim)',
  async ({ I }) => {
    await I.amOnCitizenAppPage('');
    await I.authenticateWithIdam(userType.CITIZEN, true);
    const claimRef = await I.createClaimDefendantAsOrg();
...
Scenario(
  'Claimant create a case --> Caseworker submit N11 (Paper Dispute all)',
  async ({ I }) => {
    await I.amOnCitizenAppPage('');
    await I.authenticateWithIdam(userType.CITIZEN, true);
    const claimRef = await I.createClaimDefendantAsOrg();
...
Scenario(
  'Claimant create a case --> Caseworker submit N180 (Paper DQ)',
  async ({ I }) => {
    await I.amOnCitizenAppPage('');
    await I.authenticateWithIdam(userType.CITIZEN, true);
    const claimRef = await I.createClaimDefendantAsOrg();
...
Scenario(
  'Claimant create a case --> Caseworker submit N225 (CCJ request)',
  async ({ I }) => {
    await I.amOnCitizenAppPage('');
    await I.authenticateWithIdam(userType.CITIZEN, true);
    const claimRef = await I.createClaimDefendantAsOrg();
...
Scenario(
  'Claimant create a case --> Caseworker submit N244 (General application)',
  async ({ I }) => {
    await I.amOnCitizenAppPage('');
    await I.authenticateWithIdam(userType.CITIZEN, true);
    const claimRef = await I.createClaimDefendantAsOrg();
...
Scenario(
  'Claimant create a case --> Caseworker submit N245 (Application to vary)',
  async ({ I }) => {
    await I.amOnCitizenAppPage('');
    await I.authenticateWithIdam(userType.CITIZEN, true);
    const claimRef = await I.createClaimDefendantAsOrg();
...
Scenario(
  'Claimant create a case --> Caseworker submit EX160 (Help with court fees)',
  async ({ I }) => {
    await I.amOnCitizenAppPage('');
    await I.authenticateWithIdam(userType.CITIZEN, true);
    const claimRef = await I.createClaimDefendantAsOrg();
...
Scenario(
  'Claimant create a case --> Caseworker submit Non prescribed documents',
  async ({ I }) => {
    await I.amOnCitizenAppPage('');
    await I.authenticateWithIdam(userType.CITIZEN, true);
    const claimRef = await I.createClaimDefendantAsOrg();
