...
Scenario(
  'End to end:claimant Entering Breathing Space via Online and ccd staff Lifting BS via CCD',
  async ({ I }) => {
...
Scenario(
  'Negative: Caseworker cannot Enter Breathing Space When Case handed to CCBC',
  async ({ I }) => {
    logger.info('The launchDarklyBreathingSpace flag is ', launchDarklyBSFlag);
    if (launchDarklyBSFlag === true) {
      //claimant steps
