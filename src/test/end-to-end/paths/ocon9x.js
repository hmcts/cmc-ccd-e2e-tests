...
Scenario(
  "Claimant create a case --> Caseworker submit ocon9x event and paper resp admission",
  async ({ I }) => {
...
Scenario(
  "Claimant create a case --> Caseworker submit ocon9x event and paper resp defence",
  async ({ I }) => {
    logger.info("The launchDarklyOCONFlag is set to ..", launchDarklyOCONFlag);
    if (launchDarklyOCONFlag === true) {
      //claimant steps
