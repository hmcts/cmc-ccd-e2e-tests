...
module.exports = async function () {
  ...
  await I.seeCheckboxIsChecked(
    `#directionList-${judgeDrawDirectionOrderConfig.page2_directionList_docs}`
  );
  await I.seeCheckboxIsChecked(
    `#directionList-${judgeDrawDirectionOrderConfig.page2_directionList_witness}`
  );

  await I.uncheckOption(
    `#directionList-${judgeDrawDirectionOrderConfig.page2_directionList_docs}`
  );
  await I.uncheckOption(
    `#directionList-${judgeDrawDirectionOrderConfig.page2_directionList_witness}`
  );
  await I.dontSeeCheckboxIsChecked(
    `#directionList-${judgeDrawDirectionOrderConfig.page2_directionList_docs}`
  );
  await I.dontSeeCheckboxIsChecked(
    `#directionList-${judgeDrawDirectionOrderConfig.page2_directionList_witness}`
  ...
  await I.click(
    `#docUploadForParty-${judgeDrawDirectionOrderConfig.page2_defendant}`
  );

  await I.fillField(
    "#docUploadDeadline-day",
    judgeDrawDirectionOrderConfig.page2_docUploadDeadline_day
  );
  await I.fillField(
    "#docUploadDeadline-month",
    judgeDrawDirectionOrderConfig.page2_docUploadDeadline_month
  );
  await I.fillField(
    "#docUploadDeadline-year",
    judgeDrawDirectionOrderConfig.page2_docUploadDeadline_year
  );

  await I.click(
    `#eyewitnessUploadForParty-${judgeDrawDirectionOrderConfig.page2_defendant}`
  );

  await I.fillField(
    "#eyewitnessUploadDeadline-day",
    judgeDrawDirectionOrderConfig.page2_docUploadDeadline_day
  );
  await I.fillField(
    "#eyewitnessUploadDeadline-month",
    judgeDrawDirectionOrderConfig.page2_docUploadDeadline_month
  );
  await I.fillField(
    "#eyewitnessUploadDeadline-year",
    judgeDrawDirectionOrderConfig.page2_docUploadDeadline_year
  );

  await I.click(
    `#grantExpertReportPermission_${judgeDrawDirectionOrderConfig.page2_grant_expertpermission_Yes}`
  );
  await I.fillField(
    "#expertReportInstruction",
    judgeDrawDirectionOrderConfig.page2_expert_instruction
  );
  ...
  await I.selectOption(
    "#otherDirections_0_extraOrderDirection",
    judgeDrawDirectionOrderConfig.page2_extraDirection
  );
  await I.click("#otherDirections_0_otherDirectionHeaders-CONFIRM");
  await I.selectOption(
    "#otherDirections_0_forParty",
    judgeDrawDirectionOrderConfig.page2_additionalOrder_claimant
  );
  await I.fillField(
    "#otherDirections_0_directionComment",
    judgeDrawDirectionOrderConfig.page2_claimantInfo
  );
  ...
  await I.selectOption(
    "#hearingCourt",
    judgeDrawDirectionOrderConfig.page2_hearingCourt
  );
  await I.selectOption(
    "#estimatedHearingDuration",
    judgeDrawDirectionOrderConfig.page2_hearingDuration
  );
