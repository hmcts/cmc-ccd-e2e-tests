...
module.exports = function () {
  return actor({
    ...
    createClaimWithHwfOptions:
      steps.claimant.createHWFClaim.createClaimWithHwfOptions,
    ...
    createClaimDefendantAsLimitedCompany:
      steps.claimant.createClaimDefendantAsLimitedCompany,
    createClaimantAsSoleTraderDefendantAsOrg:
      steps.claimant.createClaimantAsSoleTraderDefendantAsOrg,
